...
- **control_50off** (Control): Exibe o banner padrão com fundo bege (#fbf7ef), conteúdo (título, badge, CTA) e imagem de fundo
- **treatment_100off** (Variant): Exibe um banner em branco (background branco, sem conteúdo visível)
